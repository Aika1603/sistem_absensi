...
<div id="wrapper">
     <!-- Navigation -->
		...
		<div class="grid_3 grid_5">
			...
			$sql = mysqli_query($koneksi, "SELECT * FROM admin WHERE user_id='$admin'");
				...
				$update = mysqli_query($koneksi,"UPDATE admin SET password='$passwordmd5' WHERE user_id='$admin'");
				if($update){
			...
			$sql = mysqli_query($koneksi, "SELECT * FROM admin WHERE user_id='$user_id'");
