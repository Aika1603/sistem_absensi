...
$no_hp = $_SESSION["no_hp"];
			...
			if(isset($_FILES['fileToUpload'])){
				...
				if ($uploadOk == 0) {
					...
					$file = $target_dir.''.$user_id.'.'.$imageFileType;
					$new_user_name = $user_id.'.'.$imageFileType;
					if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $file)) {
						$up = mysqli_query($koneksi, "UPDATE ".$akses." SET avatar='$new_user_name' WHERE user_name='$user_name'");
