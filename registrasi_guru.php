...
$id_mengajar=mysqli_real_escape_string($koneksi,$_POST['id_mengajar']);  
...
$sql="Insert into guru(NIP,user_name,user_akses,password,avatar,id_mengajar,no_hp,email) values('$NIP','$user_name','guru', '$password','avatar.png', '$id_mengajar','$no_hp','$email');";
								...
								<!--/login-->
									   ...
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
													<div class="login">
														<h3 class="inner-tittle t-inner">Registrasi Guru</h3>
																...
																<input type="text" class="text" name="NIP"   placeholder="NIP" required />																	
																		...
																		<input type="text" class="text" name="id_mengajar"   placeholder="ID Mengajar" required>
