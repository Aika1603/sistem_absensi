...
<div id="wrapper">
     <!-- Navigation -->
		...
		<div class="grid_3 grid_5">
			...
			echo '<div class="alert alert-success">Data berhaasil disimpan..</div>';}
				if(isset($_GET['NIS'])){
			...
			<form class="form-horizontal" action="prosesedit.php" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="kelas" class="form-control1" value="<?php echo $row['kelas']; ?>" placeholder="KELAS"  required disabled>
					</div>
				</div>
				<div class="form-group">
