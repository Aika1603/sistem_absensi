     ...
     <!-- Navigation -->
		...
		<div class="grid_6 grid_5">
			...
			if(isset($_POST['add'])){
				...
				$id_pelajaran			= htmlspecialchars($_POST['id_pelajaran']);
				$materi			= htmlspecialchars($_POST['materi']);
				$hari	 	= htmlspecialchars($_POST['hari']);
				$kelas		 	= htmlspecialchars($_POST['kelas']);
				$jam_belajar	= htmlspecialchars($_POST['jam_belajar']);
			...
			<form class="form-horizontal" action="" method="post">
				...
				<label class="col-sm-3 control-label">KELAS</label>
					<div class="col-sm-3">
						<input type="text" name="kelas" class="form-control1" id="disabledinput"  placeholder="" required>
					</div>
				</div>
				<div class="form-group">
