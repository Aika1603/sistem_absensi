 ...
 width: 105px;
  ...
  position:center;"/></a>
                    ...
                    <ul class="nav" id="side-menu">
                      ...
                      <li>
					  <?php if($_SESSION['kelas']=='Pembina' or $_SESSION['kelas']==NULL){}else{?>
                            <a href="# 	"><i class="fa fa-laptop nav_icon"></i>Data Wali Kelas<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="dataabsen.php"><i class="fa fa-laptop nav_icon"></i>Data Absensi <?php echo $_SESSION['kelas'];?></a>
                            
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="rekapabsen.php"><i class="fa fa-laptop nav_icon"></i>Rekapitulasi <?php echo $_SESSION['kelas'];?></a>
					  ...
					  <?php };?>
						...
						<li>
                            <a href="#"><i class="fa fa-indent nav_icon"></i>Data Absensi Pelajaran<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
							
						   
                        
                        <li>
                            <a href="dataabsenpelajaran.php"><i class="fa fa-indent nav_icon"></i>Data Absensi </a>
                            
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="rekapabsenpelajaran.php"><i class="fa fa-indent nav_icon"></i>Rekapitulasi </a>
