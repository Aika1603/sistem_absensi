...
$sql="Insert into admin(user_name,user_akses,password,avatar,alamat,no_hp,email) values('$user_name','admin','$password','avatar.png', '$alamat','$no_hp','$email');";
								...
								<!--/login-->
									   ...
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
													<div class="login">
														<h3 class="inner-tittle t-inner">Registrasi Admin</h3>
