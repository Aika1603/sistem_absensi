					...
					echo '
						...
						<td>'.tanggal($row['tgl_lahir']).'</td>
							...
							<td>
								...
								<a href="datasiswa.php?aksi=delete&NIS='.$row['NIS'].'" title="Hapus Data" onclick="return confirm(\'Yakin?\')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
